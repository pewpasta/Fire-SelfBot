...
print(Fore.MAGENTA + "Please Login or Register!\n\n")
print("[1]Login [2]Register\n")
auswahl = input(">>")
if auswahl == "2":
    print(Fore.GREEN + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Enter your key\n")
    key = input(">>")
    print(Fore.GREEN + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Now enter your wished username and password\n")
    wisheduser = input("Username >>")
    wishedpass = input("\nPassword >>")
    if "\"" in key:
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Key")
        os._exit(0)
    if "'" in key:
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Key")
        os._exit(0)
    if "\"" in wisheduser:
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Username")
        os._exit(0)
    if "\"" in wishedpass:
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Password")
        os._exit(0)
    if "'" in wisheduser:
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Username")
        os._exit(0)
    if "'" in wishedpass:
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Password")
        os._exit(0)
    #wishedpass = hashlib.sha512(wishedpass.encode()).hexdigest()
    r5 = requests.get(f"https://xefox.tk/keyredeem.php?key={key}&user={wisheduser}&pass={wishedpass}")
    if r5.content == b"Invalid Key":
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid key\n")
        input("Press Enter to exit")
        os._exit(0)
    if r5.content == b"already redeemed":
        print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Key was already redeemed\n")
        input("Press Enter to exit")
        os._exit(0)
    if r5.content == b"kk":
        data = {}
        ...
        with open('auth.json', 'w+') as outfile:
            ...
            input("[AUTH] Registered sucessfully press Enter to restart the selfbot")
    else:
        print(Fore.RED + "[SERVER]" + Fore.RESET + Fore.MAGENTA + " Login Server Error\n")
        input("Press Enter to exit")
        os._exit(0)
    if os.name == "nt":
            os.system("start XEFOX.exe")
            os._exit(0)
if os.name == "posix":
    os.system("./XEFOX")
    os._exit(0)   
user5 = input("Enter your username\n >>")
passdsa = input("Enter your password\n >>")
if "\"" in user5:
    print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Username")
    os._exit(0)
if "\"" in passdsa:
...
if "'" in passdsa:
    print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Characters in Password")
    os._exit(0)
#passdsa = hashlib.sha512(passdsa.encode()).hexdigest()
#hwid = hashlib.sha512(hwid.encode()).hexdigest()
r2 = requests.get(f"https://your.domain/authserver.php?user={user5}&pass={passdsa}&hwid={hwid}")
if r2.content == b'Wrong HWID':
    print(Fore.RED + "[HWID]" + Fore.RESET + Fore.MAGENTA + " HWID does not match\n")
    input("Press Enter to exit")
    os._exit(0)
if r2.content == b'Wrong password':
    print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Wrong username or password\n")
    input("Press Enter to exit")
    os._exit(0)
data = {}
data = ({
...
with open('auth.json', 'w+') as outfile:
    json.dump(data, outfile)
with open('./auth.json', 'r') as cjson:
    auth = json.load(cjson)
user5 = auth["username"]
passdsa = auth["password"]
if "\"" in user5:
    print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Username")
    os._exit(0)
if "\"" in passdsa:
    print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Password")
    os._exit(0)
if "'" in user5:
    print(Fore.RED + "[AUTH]" + Fore.RESET + Fore.MAGENTA + " Invalid Username")
    os._exit(0)
...
#passdsa = hashlib.sha512(passdsa.encode()).hexdigest()
#hwid = hashlib.sha512(hwid.encode()).hexdigest()
r = requests.get(f"https://your.domain/authserver.php?user={user5}&pass={passdsa}&hwid={hwid}")
if r.content == b'Wrong HWID':
    print(Fore.RED + "[HWID]" + Fore.RESET + Fore.MAGENTA + " HWID does not match\n")
    input("Press Enter to exit")
    os._exit(0)
...
if r.content == b'All Right':
    print(Fore.GREEN + "[AUTH]" + Fore.RESET + Fore.MAGENTA + "Login completed sucessfully")
else:
    print(Fore.RED + "[SERVER]" + Fore.RESET + Fore.MAGENTA + "Login Server error!")
    input("Press Enter to exit")
    os._exit(0)
